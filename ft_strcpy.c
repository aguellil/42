...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2015/12/10 03:00:08 by aguellil          #+#    #+#             */
/*   Updated: 2016/01/28 01:34:48 by aguellil         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**char	*ft_strcpy(char *dst, const char *src)
**{
**	dst = ft_strncpy(dst, src, ft_strlen(src) + 1);
**	return (dst);
**}
*/
...
**      stpncpy() functions return a pointer to the terminating `\0' character
...
**      and NUL terminates the result.  Because strncpy() does not guarantee to
